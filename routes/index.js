...
module.exports = function(app) {
    ...
    app.get('/u/:name/:minute/:title', function (req, res) {
        Post.getOne(req.params.name, req.params.minute, req.params.title, function
            (err, post) {
            if (err) {
                req.flash('error', err);
                return res.redirect('/');
    ...
    app.get('/edit/:name/:minute/:title', checkLogin,function(req, res){
        ...
        Post.edit(currentUser.name, req.params.minute, req.params.title, function
            (err, post) {
            if (err) {
                req.flash('error', err);
    ...
    app.post('/edit/:name/:minute/:title',checkLogin,function (req, res) {
        Post.update(req.params.name,req.params.minute,req.params.title,req.body.post,function (err) {
                var url = encodeURI('/u/' + req.params.name
                    + '/' + req.params.minute+ '/' + req.params.title);
                if(err){
                    req.flash('error', err);
    ...
    app.post('/comment/:name/:minute/:title',function (req,res) {
        ...
        var newComment = new Comment(req.params.name,req.params.minute,req.params.title,commment);
